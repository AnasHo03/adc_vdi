...
class Chatter():
    ...
    def cam_callback(self, col_img_raw):
        ...
        servoW = self.servoW/100

        #self.rpm_target = self.rpm_target/servoW + 4000

        deltay = self.rpm_target-1500
        deltax = 0.75
        ...
        if servoW > 0.8:
            ...
            if servoW < 0.1:
                self.rpm_target = 4000
            else:
                self.rpm_target = 4000 - deltay/deltax * self.servoW
        
        
        if self.rpm_target < 1500:
            self.rpm_target = 1500
