...
#parking constants
parallel_parking = True #Change to "True" for parallel parking
...
wait_detection_p = 1 #time to wait after Spot detection parallel
...
class Chatter():
    def __init__(self):
        ...
        self.rpm_target = 2000           #Speed to Drive
    ...
    def hook(self):
        ...
        if self.killswitch_shutdown == False:
            if self.p_slot_det == True:
                ...
                spawn_program_and_die(['python3', '/home/nano/mechatroniklabor_ws/src/wettbewerb/hard_code_ctrl.py'])
            if self.c_slot_det == True:
