...
#parking constants
parallel_parking= False  #Change to "False" for Cross parking

tolerance=15            #tolerance distance in cm

taken = 27     #distance taken spot in cm
free_parallel = 66    #distance free_parallel in cm
...
wait_detection_c = 0.1 #time to wait after Spot detection cross
    ...
    def hook(self):
        ...
        if self.killswitch_shutdown == False:
            if self.p_slot_det == True:
                ...
                spawn_program_and_die(['python3', '/home/nano/mechatroniklabor_ws/src/control/parking/hard_code_ctrl.py'])
            if self.c_slot_det == True:
                print("Ready for Cross Programm")
                spawn_program_and_die(['python3', '/home/nano/mechatroniklabor_ws/src/control/parking/cross_parking_ctrl.py'])
                #hier Programm für Cross einfügen
