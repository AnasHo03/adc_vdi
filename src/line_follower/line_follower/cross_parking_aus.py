            ...
            if self.ausparken_ok:
                    ...
                    if self.parking_step == 0 :
                        ...
                        if abs(self.difference_displcament) <= 200 :
                            self.send_ackermann(-0.5, 0.4) # here add the traffic light condition if it is red car stops and by green car drives
    ...
    def cross_ausparken(self):
        ...
        if self.ausparking_step == 0:
            ...
            if self.ausparking_step_counter_1 == 0:
                ...
                self.reset_displacement()
            if abs(self.difference_displcament) <= 1600 : 
        ...
        #         self.reset_displacement()
        #     if abs(self.difference_displcament) <= 1200 : 
    ...
    def cross_parking_manouver(self):
        ...
        if self.parking_step == 0:
            ...
            if self.parking_step_counter_1 == 0:
                ...
                self.reset_displacement()
            if abs(self.difference_displcament) <= 900 : 
                self.send_ackermann(0.5,-0.3)
            else :
                self.parking_step = 2
